  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 shrink-0 items-center justify-end gap-1">
        ...
        <HelpMenuRoot />
        {/* Upstream's "Star us on GitHub" is removed: this is an internal
            deployment, and a permanent link asking the team to star someone
            else's repository is toolbar space spent on nothing they need. */}
