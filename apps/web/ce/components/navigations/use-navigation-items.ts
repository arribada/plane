...
export const useNavigationItems = ({
  ...
  const navigationItems = useMemo(() => {
    ...
    // Sort by sortOrder
    // Array#toSorted() is ES2023 and this app type-checks against lib ES2022; filteredItems is a
    // fresh array from filter(), so sorting it in place is already side-effect free.
