...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The work item is the building block of the platform. Most concepts here are either associated with work items and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
    ...
    description:
      "Sprints help you and your team to progress faster: a fixed period you plan, run and close as one thing.",
    image: CyclesTour,
    prevStep: "work-items",
    nextStep: "modules",
  },
          ...
          <div className="h-full overflow-hidden">
            ...
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Welcome to Arribada, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                This is where Arribada plans its conservation technology work. You can now manage your projects with
