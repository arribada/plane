...
export const ProjectNavigation = observer(function ProjectNavigation(props: TProjectItemsProps) {
    ...
    (navWorkspaceSlug: string, navProjectId: string): TNavigationItem[] => [
      {
        ...
        key: "overview",
        name: "Overview",
        href: `/${navWorkspaceSlug}/projects/${navProjectId}/overview`,
  ...
  const navigationItemsMemo = useMemo(() => {
    ...
    // Array#toSorted() is ES2023 and this app type-checks against lib ES2022; navigationItems()
    // returns a freshly built array, so sorting it in place is already side-effect free.
